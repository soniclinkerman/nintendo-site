                    ...
                    <div className="trending-bar">
                        ...
                        <div className="columns">
                            ...
                            <div className="trending-comp col">
                                ...
                                <img src={ac}/>
                                <a href="#" className="title">Animal Crossing<span>TM</span>:<br/> New Horizon</a>
                            ...
                            <div className="trending-comp special col">
                                ...
                                <a href="#" className="title">Minecraft Dungeons</a>
                        ...
                        <div className="trending-comp col">
                                <a className="product" href="">
                                <img src={xenoblade}/>
                                <a href="#" className="title">Xenoblade Chronicles<span>TM</span>:<br/> Definitive Edition</a>
                            ...
                            <div className="trending-comp col">
                                <a className="product" href="">
                                <img src={m_s}/>
                                <a href="#" className="title">Mario & Sonic at the<br/> Olympic Games<br/>Tokyo 2020</a>
